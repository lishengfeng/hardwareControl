...
//DMA
#define DMAC1_BASE 0x75100000

#define DMACConfiguration           *(volatile unsigned long*)(DMAC1_BASE + 0x030) 
#define DMACSync                    *(volatile unsigned long*)(DMAC1_BASE + 0x034) 
#define DMACC0SrcAddr               *(volatile unsigned long*)(DMAC1_BASE + 0x100) 
#define DMACC0DestAddr              *(volatile unsigned long*)(DMAC1_BASE + 0x104) 
#define DMACC0LLI                   *(volatile unsigned long*)(DMAC1_BASE + 0x108) 
#define DMACC0Control0              *(volatile unsigned long*)(DMAC1_BASE + 0x10C) 
#define DMACC0Control1              *(volatile unsigned long*)(DMAC1_BASE + 0x110) 
#define DMACC0Configurationguration *(volatile unsigned long*)(DMAC1_BASE + 0x114) 
