...
//window1 RGB 888
	WINCON1=(1<<6)|(11<<2)|(0<<1)|(1);//[1]随意,但之后要对应
...
void draw_rgb888(int x,int y, int color)
{
	*((unsigned long*)(0x50000000+480*272*4) + y*480 +x) = color; //long* 长度为4字节,一个像素刚好4个字节,所以直接+y*480+x, +480*272*4 是第二个窗口的首地址
